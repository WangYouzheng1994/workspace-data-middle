...
public class OrderWideApp {
    public static void main(String[] args) throws Exception {
        ...
        // env.setStateBackend(new FsStateBackend("hdfs://hadoop100:8020/gmall/checkpoint/uniquevisit"));
        ...
        SingleOutputStreamOperator<OrderDetail> orderDetailWithTsDS = orderDetailDS.assignTimestampsAndWatermarks(
                WatermarkStrategy.<OrderDetail>forBoundedOutOfOrderness(Duration.ofSeconds(5))
