...
public class OracleCdcSinkMysqlSptb02d1App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> oracleSourceStream = env.addSource(oracleSource).uid("OracleCdcSinkMysqlSptb02d1AppSourceStreamSptb02d1").name("OracleCdcSinkMysqlSptb02d1AppSourceStreamSptb02d1");
        ...
        }).uid("OracleCdcSinkMysqlSptb02d1AppProcessSptb02d1").name("OracleCdcSinkMysqlSptb02d1AppProcessSptb02d1");
        ...
        processSptb02d1.addSink(JdbcSink.<Sptb02d1>getSink(sql)).setParallelism(1).uid("OracleCdcSinkMysqlSptb02d1AppOracle-cdc-mysql-sptb02d1").name("OracleCdcSinkMysqlSptb02d1AppOracle-cdc-mysql-sptb02d1");
