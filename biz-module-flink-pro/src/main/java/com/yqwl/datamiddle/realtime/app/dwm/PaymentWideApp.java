...
import com.yqwl.datamiddle.realtime.bean.PaymentInfo;
import com.yqwl.datamiddle.realtime.bean.PaymentWide;
...
public class PaymentWideApp {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //2.1 读取支付数据
        FlinkKafkaConsumer<String> paymentInfoSource = KafkaUtil.getKafkaSource(paymentInfoSourceTopic, groupId);
        ...
        paymentWideDS.map(
            ...
            KafkaUtil.getKafkaSink(paymentWideSinkTopic)
        );
