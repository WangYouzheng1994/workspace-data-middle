 ...
 */
package org.datamiddle.cdc.oracle.bean.element;
...
import org.datamiddle.cdc.oracle.bean.element.column.NullColumn;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.*;

import static org.datamiddle.cdc.oracle.bean.element.ClassSizeUtil.getStringSize;
...
public final class ColumnRowData implements RowData, Serializable {
    ...
    public ColumnRowData( int arity, int byteSize) {
        this.columnList = new ArrayList<>(arity);
        // this.kind = kind;
