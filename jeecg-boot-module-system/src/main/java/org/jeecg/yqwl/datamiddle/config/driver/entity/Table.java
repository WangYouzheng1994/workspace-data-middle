...
import org.jeecg.yqwl.datamiddle.config.driver.driver.SqlUtil;
...
public class Table implements Serializable, Comparable<Table>, Cloneable {
    ...
    public String getSchemaTableName() {
        return StringUtils.isEmpty(schema) ? name : schema + "." + name;
    }

    @Transient
    public String getSchemaTableNameWithUnderline() {
        return StringUtils.isEmpty(schema) ? name : schema + "_" + name;
    }
    ...
    public String getFlinkTableWith(String flinkConfig) {
        String tableWithSql = "";
        if (StringUtils.isNotEmpty(flinkConfig)) {
    ...
    public String getFlinkDDL(String flinkConfig, String tableName) {
        ...
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (StringUtils.isNoneBlank(columns.get(i).getComment())) {
    ...
    public String getSqlSelect(String catalogName) {
        ...
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (StringUtils.isNoneBlank(columnComment)) {
